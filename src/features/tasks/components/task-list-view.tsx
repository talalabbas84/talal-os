...
function TaskRow({ task }: { task: TaskWithProject }) {
  ...
  return (
    <div className="group flex items-start gap-3 rounded-lg border border-neutral-100 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-950">
      ...
      <div className="min-w-0 flex-1 space-y-1">
        ...
        <div className="flex items-center gap-3">
          {task.project && (
            <span className="text-xs text-neutral-400">{task.project.name}</span>
          )}
          {task.dueDate && (
...
export function TaskListView({ tasks }: { tasks: TaskWithProject[] }) {
